...
class IdentitySigningKeyModel(Base):
    ...
    __table_args__ = (
        Index("ix_identity_signing_keys_active", "is_active", "created_at_utc"),
    )
...
class IdentityAuditLogModel(Base):
    ...
    __table_args__ = (
        Index(
            "ix_identity_audit_log_target", "target_type", "target_id", "created_at_utc"
        ),
...
class IdentityOutboxModel(Base):
    ...
    __table_args__ = (
        Index(
            "ix_identity_outbox_status_attempt", "publish_status", "next_attempt_at_utc"
        ),
